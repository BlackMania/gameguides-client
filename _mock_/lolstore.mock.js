import Vue from 'vue'
import zed from './zed.mock'
import guide from './guide.mock'
import runes from '@/assets/lol/10.6.1/data/en_US/runesReforged.json'
// League of Legends Store Mock
const lolStore = {
    state: {
        championData: zed,
        individualChampionData: zed,
